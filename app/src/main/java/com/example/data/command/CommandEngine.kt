...
object CommandEngine {
    ...
    val BUILT_IN_COMMANDS: List<CustomCommandEntity> = listOf(
        ...
        CustomCommandEntity(
            ...
            description = "Open Navigator Panel (tabs, chats, environments & files)",
            type = CommandType.BROWSER_ACTION,
            template = "tab_overview",
            aliasesRaw = "/switcher,/windows,/navigator,/nav",
            category = CommandCategory.BROWSER,
            isEnabled = true,
            isPinned = false,
            isBuiltIn = true
        ...
        CustomCommandEntity(
            ...
            description = "Toggle autonomous Agent mode on/off (or '/agent /on', '/agent /off', '/agent /on /voice /off')",
            type = CommandType.BROWSER_ACTION,
            template = "agent_dashboard",
            aliasesRaw = "/agentic,/atlas,/comet,/dia,/cns,/dashboard",
        ...
        CustomCommandEntity(
            id = "cmd_voice",
            command = "/voice",
            name = "Voice Interaction Layer",
            description = "Toggle Voice interaction on/off (or '/voice /on', '/voice /off', '/voice /on /agent /off')",
            type = CommandType.BROWSER_ACTION,
            template = "voice_mode",
            aliasesRaw = "/mic,/speak",
            category = CommandCategory.AUTOMATION,
            isEnabled = true,
            isPinned = true,
            isBuiltIn = true
        ...
        CustomCommandEntity(
            ...
            description = "Toggle Text input mode on/off (or '/text /on', '/text /off')",
            type = CommandType.BROWSER_ACTION,
            template = "text_mode",
            aliasesRaw = "/chat,/type",
            category = CommandCategory.AUTOMATION,
            isEnabled = true,
            isPinned = true,
            isBuiltIn = true
        ...
        CustomCommandEntity(
            ...
            command = "/on",
            name = "Enable Mode",
            description = "Turn ON voice or agent mode (e.g. '/on /voice', '/on /agent')",
            type = CommandType.BROWSER_ACTION,
            template = "enable_mode",
            aliasesRaw = "/enable,/start",
            category = CommandCategory.AUTOMATION,
            isEnabled = true,
            isPinned = false,
            isBuiltIn = true
        ...
        CustomCommandEntity(
            ...
            command = "/off",
            name = "Disable Mode",
            description = "Turn OFF voice or agent mode (e.g. '/off /voice', '/off /agent')",
            type = CommandType.BROWSER_ACTION,
            template = "disable_mode",
            aliasesRaw = "/disable,/stop",
            category = CommandCategory.AUTOMATION,
            isEnabled = true,
            isPinned = false,
            isBuiltIn = true
